...
async function executeCodewikiHeartbeat(
	...
	input: HeartbeatToolInput,
): Promise<{ summary: string; mode: HeartbeatMode; budget: HeartbeatBudget; cycles: Array<Record<string, unknown>>; stop: Record<string, unknown>; policy: Record<string, unknown> }> {
