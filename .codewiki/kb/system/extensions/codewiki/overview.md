...
state: active
summary: Pi package resources, adapter boundary, commands/tools, packaged skills, status UI, and generated CodeWiki templates for codewiki.
owners:
  - engineering
updated: "2026-05-05"
code_paths:
...
This boundary owns the packaged CodeWiki extension and its Pi integration surface. It translates Pi interactions into CodeWiki semantic operations while keeping canonical meaning in `.codewiki/kb`, roadmap tasks, evidence, and generated graph/index state.
...
- Product UI specs, system client specs, and system component specs define intent and constraints.
...
- Keep generated graph/index state read-only outside rebuild paths.
