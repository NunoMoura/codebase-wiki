...
- Start documentation work from the accepted `feedback_build` in a fresh session or recorded context reset when this loop follows feedback.
...
3. **Research if needed**
   ...
   - Route deeper CodeWiki research to `../playbooks/research.md`; use user-provided research skills when they are more appropriate.
...
5. **Prepare planning handoff**
   ...
   - State the required fresh-session or context-reset boundary for the planning loop.
...
- Confirm the documentation build policy includes next-loop isolation requirements.
